...
#if DEBUG_OFFLINE_CACHE
// [ADDED by GongPengjun] check which service api been cached by watching cached file names
+ (NSString *)keyForURL:(NSURL *)url
{
	...
	NSAssert1([urlString hasPrefix:@"http://api.breadtrip.com/"], @"Unkown url %@",urlString);
    ...
    // remove prefix "http://api.breadtrip.com/"
	urlString = [urlString substringFromIndex:[@"http://api.breadtrip.com/" length]];
